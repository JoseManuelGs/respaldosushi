...
import DetailsIcon from './info.png';
import PDFIcon from './pdf.png';
import InventoryIcon from './inventario.png';
import ImageIcon from './imagen.png';
import CalculatorIcon from './calculadora.png';
import ResetIcon from './reinicio.png';
...
const HistorialScreen = ({ 
  ...
  // Manejo de teclado para web
  useEffect(() => {
    if (Platform.OS !== 'web') return;

    const handleKeyDown = (e) => {
      // Permitir que InventoryTab maneje las flechas cuando está activo
      if (['ArrowUp', 'ArrowDown', 'ArrowLeft', 'ArrowRight'].includes(e.key)) {
        return;
      }
      // Aquí puedes añadir otros manejadores de teclado si es necesario
    };
